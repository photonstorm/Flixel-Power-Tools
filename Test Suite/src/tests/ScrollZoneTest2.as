package tests 
{
	...
	public class FlxScrollZoneTest2 extends FlxState
	{
		//	Common variables
		...
		[Embed(source = '../../assets/game14_angel_dawn.png')] private var angelDawnPNG:Class;
		
		private var pic:FlxSprite;
		
		public function FlxScrollZoneTest2() 
		{
		}
		...
		override public function create():void
		{
			...
			pic = new FlxSprite(0, 24, angelDawnPNG);
