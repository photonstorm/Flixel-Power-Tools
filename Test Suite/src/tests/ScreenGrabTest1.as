package tests 
{
	...
	public class FlxScreenGrabTest1 extends FlxState
	{
		//	Common variables
		...
		[Embed(source = '../../assets/spaz-bitch-beatnick.png')] private var spazPNG:Class;
		[Embed(source = '../../assets/balls.png')] private var ballsPNG:Class;
		...
		public function FlxScreenGrabTest1() 
		{
		}
		...
		override public function create():void
		{
			...
			canvas = new FlxSprite(0, 32).makeGraphic(320, 190, 0xff000000, true);
			...
			balls.minRotation = 0;
			balls.maxRotation = 0;
			balls.makeParticles(ballsPNG, 30, 0, true, 0);
			balls.start(false);
