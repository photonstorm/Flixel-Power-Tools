package tests 
{
	...
	public class FlxScrollingTextTest3 extends FlxState
	{
		//	Common variables
		...
		[Embed(source = '../../assets/fonts/steel.png')] private var steelFontPNG:Class;
		[Embed(source = '../../assets/fonts/260.png')] private var metalFontPNG:Class;
		[Embed(source = '../../assets/fonts/knight3.png')] private var knightHawksFontPNG:Class;
		...
		public function FlxScrollingTextTest3() 
		{
		}
		...
		override public function create():void
		{
			...
			font1 = new FlxBitmapFont(steelFontPNG, 32, 32, FlxBitmapFont.TEXT_SET10 + "0123456789.!?\"", 10);
			font2 = new FlxBitmapFont(metalFontPNG, 46, 48, FlxBitmapFont.TEXT_SET10 + "0123456789?!().,", 6, 2, 2);
			font3 = new FlxBitmapFont(knightHawksFontPNG, 31, 25, FlxBitmapFont.TEXT_SET6, 10, 1, 1);
