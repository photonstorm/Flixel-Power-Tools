package tests 
{
	...
	public class FlxButtonPlusTest1 extends FlxState
	{
		//	Common variables
		...
		public function FlxButtonPlusTest1() 
		{
		}
		...
		override public function create():void
		{
			...
			button2.updateInactiveButtonColors([ 0xFF0080, 0xFF80C0 ]);
			button2.updateActiveButtonColors([ 0xFFFF00, 0xFF8000 ]);
			button2.screenCenter();
			
			//	This is a default button with no extra styling or changes. It will send 2 parameters, a String and a Number to the onClick function, when clicked.
			button3 = new FlxButtonPlus(32, 116, onClick, [ "Commodore", 64 ], "Roll Over and Out", 140);
			button3.updateInactiveButtonColors([ 0xFF0000, 0xFF8000, 0xFFFF00 ]);
